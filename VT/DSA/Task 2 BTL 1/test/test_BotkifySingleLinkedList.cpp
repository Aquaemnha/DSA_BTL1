#include "doctest.h"
#include "src/BotkifySingleLinkedList.h"

TEST_CASE("BotkifySingleLinkedList_001")
{
    BotkifySingleLinkedList<int> list;
...
TEST_CASE("BotkifySingleLinkedList_002")
{
    BotkifySingleLinkedList<int> list;
...
TEST_CASE("BotkifySingleLinkedList_003")
{
    BotkifySingleLinkedList<string> list;
...
TEST_CASE("BotkifySingleLinkedList_004")
{
    BotkifySingleLinkedList<int> list;
...
TEST_CASE("BotkifySingleLinkedList_005")
{
    BotkifySingleLinkedList<int> list;
...
TEST_CASE("BotkifySingleLinkedList_006")
{
    BotkifySingleLinkedList<int> list;
