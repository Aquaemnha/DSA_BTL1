#include "doctest.h"
#include "src/BotkifyDoubleLinkedList.h"

TEST_CASE("BotkifyDoubleLinkedList_001")
{
    BotkifyDoubleLinkedList<int> list;
...
TEST_CASE("BotkifyDoubleLinkedList_002")
{
    BotkifyDoubleLinkedList<int> list;
...
TEST_CASE("BotkifyDoubleLinkedList_003")
{
    BotkifyDoubleLinkedList<string> list;
...
TEST_CASE("BotkifyDoubleLinkedList_004")
{
    BotkifyDoubleLinkedList<int> list;
...
TEST_CASE("BotkifyDoubleLinkedList_005")
{
    BotkifyDoubleLinkedList<int> list;
...
TEST_CASE("BotkifyDoubleLinkedList_006")
{
    BotkifyDoubleLinkedList<int> list;
