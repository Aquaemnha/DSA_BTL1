#include "doctest.h"
#include "src/BotkifyCycleDoubleLinkedList.h"

TEST_CASE("BotkifyCycleDoubleLinkedList_001")
{
    BotkifyCycleDoubleLinkedList<int> list;
...
TEST_CASE("BotkifyCycleDoubleLinkedList_002")
{
    BotkifyCycleDoubleLinkedList<int> list;
...
TEST_CASE("BotkifyCycleDoubleLinkedList_003")
{
    BotkifyCycleDoubleLinkedList<string> list;
...
TEST_CASE("BotkifyCycleDoubleLinkedList_004")
{
    BotkifyCycleDoubleLinkedList<int> list;
...
TEST_CASE("BotkifyCycleDoubleLinkedList_005")
{
    BotkifyCycleDoubleLinkedList<int> list;
...
TEST_CASE("BotkifyCycleDoubleLinkedList_006")
{
    BotkifyCycleDoubleLinkedList<int> list;
